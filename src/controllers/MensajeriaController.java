 ...
 */
public final class MensajeriaController implements ActionListener, MouseListener, ItemListener {

    private final jMensajeriaEnviar viewMensajeria;
    ...
    public MensajeriaController(jMensajeriaEnviar viewMensajeria, jprincipal viewPrincipal, Login login) {
        ...
        if (e.getSource() == viewMensajeria.jbEmail) {
            if (viewMensajeria.jComboPlantilla.getSelectedIndex() == 0) {
                ...
                try {
                    ...
                    email.envioEmail(viewMensajeria, thread);
